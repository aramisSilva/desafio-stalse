export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 font-sans px-6 py-16">
      <div className="max-w-2xl text-center space-y-6">
        ...
        <p className="text-lg leading-relaxed text-zinc-600 dark:text-zinc-300">
          ...
          <br />
          O projeto é composto por um backend em <strong>FastAPI</strong>, um frontend em <strong>Next.js</strong>,
        ...
        <section className="bg-white/60 dark:bg-zinc-800/50 rounded-xl p-6 text-left shadow-sm space-y-3">
          ...
          <ul className="list-disc list-inside space-y-2 text-zinc-700 dark:text-zinc-300">
            ...
            <li>
              <strong>/dashboard</strong> — Exibe métricas processadas do dataset Kaggle (quantidade por dia, tópicos e canais).
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white/60 dark:bg-zinc-800/50 rounded-xl p-6 text-left shadow-sm space-y-3">
          ...
          <ol className="list-decimal list-inside space-y-2 text-zinc-700 dark:text-zinc-300">
            <li>
              Execute o backend (FastAPI) com:{" "}
              <code className="bg-zinc-200 dark:bg-zinc-700 px-2 py-1 rounded">uvicorn backend.main:app --reload</code>
            </li>
            <li>
              Execute o frontend (Next.js) com:{" "}
              <code className="bg-zinc-200 dark:bg-zinc-700 px-2 py-1 rounded">npm run dev</code>
            </li>
            <li>
              Acesse as rotas no navegador em:{" "}
              <code className="bg-zinc-200 dark:bg-zinc-700 px-2 py-1 rounded">http://localhost:3000</code>
            </li>
            <li>
              Use o n8n para capturar eventos quando um ticket for fechado ou tiver prioridade alta.
            </li>
          </ol>
        </section>
